// Canonical statement of the agent wire contract. The Go agent mirrors
// everything below this block, verbatim, at
// towerops-agent/proto/agent.proto - edit this copy first, then reproduce the
// change there. The hand-written codec in lib/towerops/proto/ implements what
// is written here, and test/towerops/proto/network_sweep_test.exs pins the
// bounds these comments promise to a non-Elixir reader.
...
type MikrotikCommand struct {
	...
	// Ordered RouterOS API words. New senders populate both words and args during
	// rollout; new agents prefer words, while older agents continue using args.
...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\fAgentJobList\x12,\n" +
	"\x04jobs\x18\x01 \x03(\v2\x18.towerops.agent.AgentJobR\x04jobs\"\xa6\x03\n" +
	"\bAgentJob\x12\x15\n" +
	...
	"\x10interval_seconds\x18\b \x01(\rR\x0fintervalSeconds\"\xfb\x02\n" +
	"\n" +
	"SnmpDevice\x12\x0e\n" +
...
var file_proto_agent_proto_goTypes = []any{
	...
	(*NetworkSweepResult)(nil),   // 27: towerops.agent.NetworkSweepResult
	(*SweepResult)(nil),          // 28: towerops.agent.SweepResult
	(*AgentHeartbeat)(nil),       // 29: towerops.agent.AgentHeartbeat
	(*AgentError)(nil),           // 30: towerops.agent.AgentError
	(*CredentialTestResult)(nil), // 31: towerops.agent.CredentialTestResult
	(*MikrotikDevice)(nil),       // 32: towerops.agent.MikrotikDevice
	(*MikrotikCommand)(nil),      // 33: towerops.agent.MikrotikCommand
	(*MikrotikResult)(nil),       // 34: towerops.agent.MikrotikResult
	(*MikrotikSentence)(nil),     // 35: towerops.agent.MikrotikSentence
	(*LldpTopologyResult)(nil),   // 36: towerops.agent.LldpTopologyResult
	(*LldpNeighbor)(nil),         // 37: towerops.agent.LldpNeighbor
	(*SnmpTrap)(nil),             // 38: towerops.agent.SnmpTrap
	nil,                          // 39: towerops.agent.Sensor.MetadataEntry
	nil,                          // 40: towerops.agent.HttpCheckConfig.HeadersEntry
	nil,                          // 41: towerops.agent.SnmpResult.OidValuesEntry
	nil,                          // 42: towerops.agent.MikrotikCommand.ArgsEntry
	nil,                          // 43: towerops.agent.MikrotikSentence.AttributesEntry
	nil,                          // 44: towerops.agent.SnmpTrap.VarbindsEntry
}
var file_proto_agent_proto_depIdxs = []int32{
	...
	39, // 5: towerops.agent.Sensor.metadata:type_name -> towerops.agent.Sensor.MetadataEntry
	...
	40, // 16: towerops.agent.HttpCheckConfig.headers:type_name -> towerops.agent.HttpCheckConfig.HeadersEntry
	...
	32, // 22: towerops.agent.AgentJob.mikrotik_device:type_name -> towerops.agent.MikrotikDevice
	33, // 23: towerops.agent.AgentJob.mikrotik_commands:type_name -> towerops.agent.MikrotikCommand
	...
	41, // 26: towerops.agent.SnmpResult.oid_values:type_name -> towerops.agent.SnmpResult.OidValuesEntry
	28, // 27: towerops.agent.NetworkSweepResult.results:type_name -> towerops.agent.SweepResult
	42, // 28: towerops.agent.MikrotikCommand.args:type_name -> towerops.agent.MikrotikCommand.ArgsEntry
	35, // 29: towerops.agent.MikrotikResult.sentences:type_name -> towerops.agent.MikrotikSentence
	43, // 30: towerops.agent.MikrotikSentence.attributes:type_name -> towerops.agent.MikrotikSentence.AttributesEntry
	37, // 31: towerops.agent.LldpTopologyResult.neighbors:type_name -> towerops.agent.LldpNeighbor
	44, // 32: towerops.agent.SnmpTrap.varbinds:type_name -> towerops.agent.SnmpTrap.VarbindsEntry
