...
//
// The Towerops server's copy at priv/proto/agent.proto is canonical for shared
// fields. AgentJob.interval_seconds (field 8) is the forward-compatible agent
// scheduler extension that server 0.2.0 must populate before agent 1.5.0 is
// deployed; see README.md's scheduler rollout compatibility table.
